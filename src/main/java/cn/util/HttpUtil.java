...
import cn.biz.util.AccessTokenUtil;
...
public class HttpUtil {
	...
	public static String doGet(String url) {
		...
		if (json.containsKey("errcode") && (json.getIntValue("errcode") == 40001 || json.getIntValue("errcode") == 40014
				|| json.getIntValue("errcode") == 41001 || json.getIntValue("errcode") == 42001)) {
